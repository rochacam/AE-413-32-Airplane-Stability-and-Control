...
% BODY parameters
NX = 12;
    X = [0,0.1375,4.125,6.875,9.625,14.175,18.615,21.145,23.675,26.205,28.735,30];
    ZU = [0.25,0.628,1.149,1.522,1.832,2.228,1.820,1.523,1.203,0.869,0.85,0.85];
    ZL = [-0.25,-0.628,-1.149,-1.522,-1.832,-2.228,-1.820,-1.523,-1.203,-0.869,-0.517,0];
    R = [0.5,1.256,2.298,3.044,3.664,4.456,3.640,3.046,2.406,1.738,1.034,0.5];
    S = [0.5,1.239,4.148,7.281,10.54,15.59,10.41,7.292,4.546,2.373,0.840,0.5];
